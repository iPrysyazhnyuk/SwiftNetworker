#
# Be sure to run `pod lib lint SwiftNetworker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'SwiftNetworker'
  s.version          = '1.0.0'
  s.summary          = 'HTTP Networking library built on top of Alamofire and ObjectMapper to provide simple and structured way to make requests. Forget about manual JSON parsing.'
...
SwiftNetworker is available under the MIT license. See the LICENSE file for more info.
  ...
  s.homepage         = 'https://github.com/iPrysyazhnyuk/SwiftNetworker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Igor Prysyazhnyuk' => 'i.prisyagnyuk@gmail.com' }
  s.source           = { :git => 'https://github.com/iPrysyazhnyuk/SwiftNetworker.git', :tag => s.version.to_s }
